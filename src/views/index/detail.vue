            ...
            <div class="li-content" v-if="activeIndex == 0">
                <div class="teacher-to mx-1px-bottom">
                    ...
                    <div class="teacher-detail">
                        <div class="avatar" v-if="detail_meta.teacher && detail_meta.teacher.avatar" @click="jump('index-teacher',detail_meta.teacher.id)">
                        ...
                        <div class="text">
                            <div class="name" v-if="detail_meta.teacher" @click="jump('index-teacher',detail_meta.teacher.id)">{{detail_meta.teacher.user_name}}老师</div>
                            <div class="label" v-if="detail_meta.teacher" @click="jump('index-teacher',detail_meta.teacher.id)">淘宝7年资深讲师淘宝7年资深讲师 国家工信淘宝7年资深讲师 国家工信 国家工信部高级电子商务师</div>

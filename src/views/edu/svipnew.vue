<template>
    <div id="edu-svip-new">
        <Header title="天善智能SVIP为你的数据之路保驾护航！" :fixed="true">
            <div slot="left" class="left-item">
                <i class="back iconfont icon-fanhui-"></i>
            </div>
        </Header>
        <div class="contents">
            <img src="../../static/img/banner2018svip.png" alt="" class="img-block">

            <div class="pay-box">
                <div class="pay" @click="submit" v-if="!vipData.isMember">
                    <p>￥{{vipData.svipPrice}}</p>
                    <div class="text">
                        <div class="doc-top">原价：￥1999</div>
                        <div class="pay-time"><countdown :value="vipData.svipPromotionEndTime"></countdown></div>
                        <!--<div class="pay-time"><countdown value="2019-10-30 23:59:59"></countdown></div>-->
                        <div class="pay-num">已有 {{vipData.payCount}} 人购买</div>
                    </div>
                </div>
            ...
            <img src="../../static/img/svip-ts-1015.png" alt="">

            <div class="free-box">
                <div class="title">
                    <span>人工智能、机器学习、深度学习</span>
                    <div>
                        镀金前沿技术，激活自我，赋能企业，破冰人工智能时代。
                    </div>
                </div>
                <div class="edu-list">
                    <div class="mx-1px-bottom edu-item" v-for="item in vipData.AICourses" @click="jump('edu-course',item.id)">
                        <div class="item-left">
            ...
            <div class="free-box">
                <div class="title">
                    <span>业务、分析、求职</span>
                    <div>
                        掌握数据科学，洞悉业务艺术，聆听专家职场案例，科学避坑，掌握面试技巧，全面提升竞争力。
                    </div>
                </div>
                <div class="edu-list">
                    <div class="mx-1px-bottom edu-item" v-for="item in vipData.BSCourses" @click="jump('edu-course',item.id)">
                        <div class="item-left">
                            <img :src="item.picture" alt="">
                        </div>
                        <div class="item-right">
            ...
            <div class="free-box">
                <div class="title">
                    <span>大数据、数据挖掘、R、Python</span>
                    <div>
                        广向拓展企业数据源，深度挖掘企业数据金矿，提升企业智慧运营能力
                    </div>
                </div>
                <div class="edu-list">
                    <div class="mx-1px-bottom edu-item" v-for="item in vipData.DRPCourses" @click="jump('edu-course',item.id)">
                        <div class="item-left">
                            <img :src="item.picture" alt="">
                        </div>
                        <div class="item-right">
            ...
            <div class="free-box">
                <div class="title">
                    <span>商业智能BI</span>
                    <div>
                        经典流传，支撑企业精细化管理、数据化运营之利器，成就业务与技术结合复合型人才之绝招。
                    </div>
                </div>
                <div class="edu-list">
                    <div class=" mx-1px-bottom edu-item" v-for="item in vipData.BIcourses" @click="jump('edu-course',item.id)">
                        <div class="item-left">
                            <img :src="item.picture" alt="">
                        </div>
                        <div class="item-right">
            ...
            <div class="free-box">
                ...
                <div class="edu-list">
                    <div class="mx-1px-bottom edu-item" v-for="item in vipData.OCCourses" @click="jump('edu-course',item.id)">
                        <div class="item-left">
                            <img :src="item.picture" alt="">
                        </div>
                        <div class="item-right">
            ...
            <div class="see-more" @click="go(2)">
                查看更多优质课程
            </div>

            <img src="../../static/img/2018SVIP_12.png" alt="" class="svip-img">
            ...
            <div class="question">
                ...
                <div class="item-box">
                    <div class="item">
                        <p>Q：SVIP 会员如何使用？</p>
                        <div>A：SVIP 会员使用说明可查看： <a href="https://ask.hellobi.com/blog/team/5682">https://ask.hellobi.com/blog/team/5682</a></div>
                    </div>
                    <div class="item">
        ...
        <div class="tabbar-box">
            <div class="tabbar tab-title" :class="showSubSet ? 'cur' : ''">
                ...
                <div class="tabbar-item active sred" >
                    <div class="sred-text pay" @click="submit" v-if="!vipData.isMember">立即购买SVIP</div>
                    <div class="sred-text pay" v-else>
                        您已是 SVIP 会员
                    </div>
                </div>
            </div>
...
//    		var no = this.$route.query.out_trade_no;
            var data = {
                rf: this.$route.query.rf || Cache.get(cache_keys.agent_code) || ''
            }
	        this.$Indicator.blade();
    		this.$store.dispatch('svipNewDataList',data);
//	        if (no && result) {
//		        this.$Modal.confirm({body: '购买成功'});
//	        }

    		EventBus.$on('svipNewData', this.dataSet);
    		EventBus.$on('svipNewCharge', this.svipCharge);
	        EventBus.$on('wxSvipNewCharge', this.wxSvipCharge);
        },
	    beforeDestroy() {
		    EventBus.$off('svipNewData');
	        ...
	        go(id) {
		        switch (id) {
			        ...
			        case 3:
				        ...
				        break
			        case 4:
//				        this.$router.push({name: 'edu-double'})
				        break
			        case 5:
...
<style rel="stylesheet/less" lang="less">
    #edu-svip-new{
        ...
        .contents{
            ...
            padding-bottom: 50px;
            img{
                vertical-align:middle;//middle和top也都可以,解决空隙
            }
            .time{
                margin-top: 10px;
                span{

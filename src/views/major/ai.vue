<template>
    <div id="ai">
        ...
        <div class="contents">
            <img src="../../static/img/ai_02.png" alt="">
            <img src="../../static/img/ai_03.png" alt="">
            <img src="../../static/img/ai_04.png" alt="">
            <div class="container">
            ...
            <div class="edu-list-box">
                ...
                <img src="../../static/img/ai_07.png" alt="">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created() {
            ...
            EventBus.$on('majorAi', this.majorAiData);

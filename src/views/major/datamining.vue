<template>
    <div id="datamining">
        ...
        <div class="contents">
            <img src="../../static/img/datamining_02.png" alt="">
            <img src="../../static/img/datamining_03.png" alt="">
            <img src="../../static/img/datamining_04.png" alt="">
            <div class="container">
                <div class="container-item">
                    <div class="title">
                        <div class="text">
                            必修课1：左右R右手Python课程大纲
                        </div>
            ...
            <div class="edu-list-box">
                ...
                <img src="../../static/img/datamining_06.png" alt="">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created() {
            var data = {
                url: 'major/datamining',
                name: 'Datamining'
            }
            this.$Indicator.blade();
            this.$store.dispatch('queryMajorItem', data);

            EventBus.$on('majorDatamining', this.majorDataminingData);

<template>
    <div id="bigdata">
        ...
        <div class="contents">
            <img src="../../static/img/bigdata_02.png" alt="">
            <img src="../../static/img/bigdata_03.png" alt="">
            <img src="../../static/img/bigdata_04.png" alt="">
            <div class="container">
            ...
            <div class="edu-list-box">
                ...
                <img src="../../static/img/bigdata_06.png" alt="">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created() {
            ...
            EventBus.$on('majorBigdata', this.majorBigdataData);

<template>
    <div id="python">
        ...
        <div class="contents">
            <img src="../../static/img/python_02.png" alt="">
            <img src="../../static/img/python_03.png" alt="">
            <img src="../../static/img/python_04.png" alt="">
            <div class="container">
                <div class="container-item">
                    <div class="title">
                        <div class="text">
                            必修课1：Python3 网络爬虫实战案例课程大纲
                        </div>
                ...
                <div class="container-item">
                    <div class="title">
                        <div class="text">
                            必修课2：Python3 爬虫案例实战从零开始一站通课程大纲
                        </div>
            ...
            <div class="edu-list-box">
                ...
                <img src="../../static/img/python_06.png" alt="">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created() {
            ...
            EventBus.$on('majorPython', this.majorPythonData);

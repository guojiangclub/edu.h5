<template>
    <div id="finance">
        <Header title="人工智能工程师（高级）金融风控方向">
        ...
        <div class="contents">
            <img src="../../static/img/finance_02.png" alt="">
            <img src="../../static/img/finance_03.png" alt="">
            <img src="../../static/img/finance_04.png" alt="">
            <div class="container">
                <div class="container-item">
                    <div class="title">
                        <div class="text">
                            必修课1：Python数据科学金融方向课程大纲
                        </div>
            ...
            <div class="edu-list-box">
                ...
                <img src="../../static/img/finance_07.png" alt="">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created() {
            var data = {
                url: 'major/ai/finance',
                name: 'Finance'
            }
            this.$Indicator.blade();
            this.$store.dispatch('queryMajorItem', data);

            EventBus.$on('majorFinance', this.majorFinanceData);

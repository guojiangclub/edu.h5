<template>
    <div id="bi">
        ...
        <div class="contents">
            <img src="../../static/img/bi_02.png" alt="">
            <img src="../../static/img/bi_03.png" alt="">
            <img src="../../static/img/bi_04.png" alt="">
            <div class="container">
                ...
                <div class="container-item">
                    <div class="title">
                        <div class="text">
                            必修课4：Tableau数据分析可视化课程大纲
                        </div>
                        <div @click="jump(info.courseItems4[0].courseId)">
                            立即学习
                        </div>
                    </div>
                    <div class="list">
                        <div class="item" v-for="(item, index) in info.courseItems4">
                            <div class="text" v-if="item.itemType != 'chapter'">
                                课时{{item.number}}：{{item.title}}
                            </div>
                            <div class="lock" v-if="item.itemType != 'chapter' && index == 1" @click="jump(info.courseItems4[0].courseId)">
                                查看详细大纲
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-item">
                    <div class="title">
                        <div class="text">
                            必修课5：IBM Cognos 课程大纲
                        </div>
                        <div @click="jump(info.courseItems5[0].courseId)">
                            立即学习
                        </div>
                    </div>
                    <div class="list">
                        <div class="item" v-for="(item, index) in info.courseItems5">
                            <div class="text" v-if="item.itemType != 'chapter'">
                                课时{{item.number}}：{{item.title}}
                            </div>
                            <div class="lock" v-if="item.itemType != 'chapter' && index == 1" @click="jump(info.courseItems5[0].courseId)">
                                查看详细大纲
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-item">
                    <div class="title">
                        ...
                        <div @click="jump(info.courseItems6[0].courseId)">
                            立即学习
                        </div>
                    </div>
                    <div class="list">
                        <div class="item" v-for="(item, index) in info.courseItems6">
                            <div class="text" v-if="item.itemType != 'chapter'">
                                课时{{item.number}}：{{item.title}}
                            </div>
                            <div class="lock" v-if="item.itemType != 'chapter' && index == 1" @click="jump(info.courseItems6[0].courseId)">
                                查看详细大纲
                            </div>
                        </div>
                    </div>
            ...
            <div class="edu-list-box">
                ...
                <img src="../../static/img/bi_06.png" alt="">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created() {
            ...
            EventBus.$on('majorBi', this.majorBiData);

<template>
    <div id="junior">
        ...
        <div class="contents">
            <img src="../../static/img/junior_02.png" alt="">
            <img src="../../static/img/junior_04.png" alt="">
            <img src="../../static/img/junior_05.png" alt="">
            <div class="container">
            ...
            <div class="edu-list-box">
                ...
                <img src="../../static/img/junior_07.png" alt="">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created() {
            var data = {
                url: 'major/analyst/junior',
                name: 'Junior'
            }
            this.$Indicator.blade();
            this.$store.dispatch('queryMajorItem', data);

            EventBus.$on('majorJunior', this.majorJuniorData);

<template>
    <div id="nlp">
        <Header title="人工智能工程师（高级）NLP 方向">
        ...
        <div class="contents">
            <img src="../../static/img/nlp_02.png" alt="">
            <img src="../../static/img/nlp_03.png" alt="">
            <img src="../../static/img/nlp_05.png" alt="">
            <div class="container">
            ...
            <div class="edu-list-box">
                ...
                <img src="../../static/img/nlp_07.png" alt="">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created() {
            ...
            EventBus.$on('majorNlp', this.majorNlpData);

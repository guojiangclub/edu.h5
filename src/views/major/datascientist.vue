<template>
    <div id="datascientist">
        ...
        <div class="contents">
            <img src="../../static/img/datascientist_02.png" alt="">
            <img src="../../static/img/datascientist_03.png" alt="">
            <img src="../../static/img/datascientist_05.png" alt="">
            <div class="container">
            ...
            <div class="edu-list-box">
                ...
                <img src="../../static/img/datascientist_07.png" alt="">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        created() {
            var data = {
                url: 'major/datascientist',
                name: 'Datascientist'
            }
            this.$Indicator.blade();
            this.$store.dispatch('queryMajorItem', data);

            EventBus.$on('majorDatascientist', this.majorDatascientistData);
        ...
        beforeDestroy() {
            EventBus.$off('majorDatascientist');
